...
func init() {
	...
	defaultNodeConfig.P2P.ListenAddr = ":30303"
	defaultNodeConfig.IPCPath = "bzzd.ipc"
	// Set flag defaults for --help display.
	utils.ListenPortFlag.Value = 30303
}

var app = utils.NewApp("", "BHB Swarm")
...
func keys(ctx *cli.Context) error {
	...
	_ = hex.EncodeToString(pubkey)
	_ = hex.EncodeToString(crypto.CompressPubkey(&privateKey.PublicKey))
	_ = crypto.Keccak256Hash(pubkey).Hex()

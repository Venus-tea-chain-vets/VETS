...
var (
	...
	//MainnetGenesisHash = common.HexToHash("0x0b8bd72941e85943ad268d8308308b35a18c599b000fe322764b216246bb930b")
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		ChainID:             big.NewInt(18741),
		HomesteadBlock:      big.NewInt(0),
		DAOForkBlock:        big.NewInt(0),
		DAOForkSupport:      false,//这个设置成false  下面四个eip内容失效(都是说的分叉的事情)，如果设置成true  无法同步数据
		EIP150Block:         big.NewInt(0),
		EIP150Hash:          common.HexToHash("0x11bbe8db4e347b4e8c937c1c8370e4b5ed33adb3db69cbdb7a38e1e50b1b82fa"),
		EIP155Block:         big.NewInt(0),
		EIP158Block:         big.NewInt(0),
		ByzantiumBlock:      big.NewInt(0),//以太坊在4370000高度以前是5 ether，之后是3ether
